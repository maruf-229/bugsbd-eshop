...
@section('section')
    <section class="flat-title-page style2">
        <img class="bgr-gradient gradient1" src="{{ asset('frontend/assets/images/backgroup-secsion/bg-gradient1.png') }}" alt="">
        <img class="bgr-gradient gradient2" src="{{ asset('frontend/assets/images/backgroup-secsion/bg-gradient2.png') }}" alt="">
        <img class="bgr-gradient gradient3" src="{{ asset('frontend/assets/images/backgroup-secsion/bg-gradient3.png') }}" alt="">
                    ...
                    <div class="slider-item">
                        <div class="themesflat-container ">
                            <div class="wrap-heading flat-slider flex">
                                <div class="content">
                                    <h2 class="heading">{{ $s->title_first }}</h2>
                                    <h1 class="heading mb-style"><span class="tf-text s1">{{ $s->title_second }}</span>
                                    </h1>
                                    <h1 class="heading">{{ $s->title_third }}</h1>
                                    <p class="sub-heading mg-t-29 mg-bt-44">{{ $s->sub_title }}</p>
                                ...
                                <div class="image">
                                    <img class="img-bg" src="{{ asset($s->image) }}" alt="Image">
                                    <img src="{{ asset($s->image) }}" alt="Image">
                                </div>
                            </div>
...
{{--                                <img src="{{ asset('frontend/assets/images/box-item/imgslider-3.png') }}" alt="Image">--}}
{{--                                <img class="img-bg" src="{{ asset('frontend/assets/images/backgroup-secsion/img-bg-sliderhome3.png') }}" alt="Image">--}}
{{--                            </div>--}}
                                ...
                                <div class="slider-item">
                                    <div class="sc-card-product">
                                        <div class="card-media">
                                            <a href="{{ route('item_details',$p->id) }}"><img src="{{ asset($p->image) }}" alt="Image"></a>
{{--                                            <button class="wishlist-button heart"><span class="number-like"> 100</span></button>--}}
                                        ...
                                        <div class="card-title">
                                            <h5><a href="item-details.html">"{{ $p->title }}"</a></h5>
...
{{--                                            <a href="item-details.html"><img src="{{ asset('frontend/assets/images/box-item/image-box-10.jpg') }}" alt="Image"></a>--}}
...
{{--                                            <div class="author">--}}
{{--                                                <div class="avatar">--}}
{{--                                                    <img src="{{ asset('frontend/assets/images/avatar/avt-12.jpg') }}" alt="Image">--}}
{{--                                                </div>--}}
{{--                                                <div class="info">--}}
{{--                                                    <span>Creator</span>--}}
...
{{--                                    <div class="sc-card-item">--}}
{{--                                        <div class="card-media">--}}
{{--                                            <a href="item-details.html"><img src="{{ asset('frontend/assets/images/box-item/image-box-11.jpg') }}" alt="Image"></a>--}}
...
{{--                                            <div class="author">--}}
{{--                                                <div class="avatar">--}}
{{--                                                    <img src="{{ asset('frontend/assets/images/avatar/avt-13.jpg') }}" alt="Image">--}}
{{--                                                </div>--}}
{{--                                                <div class="info">--}}
{{--                                                    <span>Creator</span>--}}
...
{{--                                    <div class="sc-card-item">--}}
{{--                                        <div class="card-media">--}}
{{--                                            <a href="item-details.html"><img src="{{ asset('frontend/assets/images/box-item/image-box-21.jpg') }}" alt="Image"></a>--}}
...
{{--                                            <div class="author">--}}
{{--                                                <div class="avatar">--}}
{{--                                                    <img src="{{ asset('frontend/assets/images/avatar/avt-14.jpg') }}" alt="">--}}
{{--                                                </div>--}}
{{--                                                <div class="info">--}}
{{--                                                    <span>Creator</span>--}}
...
{{--                                    <div class="sc-card-item">--}}
{{--                                        <div class="card-media">--}}
{{--                                            <a href="item-details.html"><img src="{{ asset('frontend/assets/images/box-item/card-item8.jpg') }}" alt="Image"></a>--}}
{{--                                            <button class="wishlist-button heart"><span class="number-like"> 100</span></button>--}}
{{--                                            <div class="featured-countdown">--}}
{{--                                                <span class="slogan"></span>--}}
{{--                                                <span class="js-countdown" data-timer="516400" data-labels=" :  ,  : , : , "></span>--}}
...
{{--                                            <div class="author">--}}
{{--                                                <div class="avatar">--}}
{{--                                                    <img src="{{ asset('frontend/assets/images/avatar/avt-11.jpg') }}" alt="Image">--}}
{{--                                                </div>--}}
{{--                                                <div class="info">--}}
{{--                                                    <span>Creator</span>--}}
{{--                                                    <h6> <a href="author02.html">SalvadorDali--}}
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="slider-item">
                                    <div class="sc-author-box style-2">
                                        <div class="author-avatar">
                                            <img src="{{ asset('frontend/assets/images/avatar/avt-1.jpg') }}" alt="" class="avatar">
                                            <div class="badge"></div>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="slider-item">
                                    <div class="sc-author-box style-2">
                                        <div class="author-avatar">
                                            <img src="{{ asset('frontend/assets/images/avatar/avt-2.jpg') }}" alt="" class="avatar">
                                            <div class="badge"></div>
                                        </div>
                                        <div class="author-infor">
                            ...
                            <div class="swiper-slide">
                                <div class="slider-item">
                                    <div class="sc-author-box style-2">
                                        <div class="author-avatar">
                                            <img src="{{ asset('frontend/assets/images/avatar/avt-4.jpg') }}" alt="" class="avatar">
                                            <div class="badge"></div>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="slider-item">
                                    <div class="sc-author-box style-2">
                                        <div class="author-avatar">
                                            <img src="{{ asset('frontend/assets/images/avatar/avt-5.jpg') }}" alt="" class="avatar">
                                            <div class="badge"></div>
                                        </div>
                                        <div class="author-infor">
                            ...
                            <div class="swiper-slide">
                                <div class="slider-item">
                                    <div class="sc-author-box style-2">
                                        <div class="author-avatar">
                                            <img src="{{ asset('frontend/assets/images/avatar/avt-3.jpg') }}" alt="" class="avatar">
                                            <div class="badge"></div>
                                        </div>
                                        <div class="author-infor">
                            ...
                            <div class="swiper-slide">
                                <div class="slider-item">
                                    <div class="sc-author-box style-2">
                                        <div class="author-avatar">
                                            <img src="{{ asset('frontend/assets/images/avatar/avt-8.jpg') }}" alt="" class="avatar">
                                            <div class="badge"></div>
                                        </div>
                                        <div class="author-infor">
                            ...
                            <div class="swiper-slide">
                                <div class="slider-item">
                                    <div class="sc-author-box style-2">
                                        <div class="author-avatar">
                                            <img src="{{ asset('frontend/assets/images/avatar/avt-6.jpg') }}" alt="" class="avatar">
                                            <div class="badge"></div>
                                        </div>
                                        <div class="author-infor">
                            ...
                            <div class="swiper-slide">
                                <div class="slider-item">
                                    <div class="sc-author-box style-2">
                                        <div class="author-avatar">
                                            <img src="{{ asset('frontend/assets/images/avatar/avt-9.jpg') }}" alt="" class="avatar">
                                            <div class="badge"></div>
                                        </div>
                                        <div class="author-infor">
                            ...
                            <div class="swiper-slide">
                                <div class="slider-item">
                                    <div class="sc-author-box style-2">
                                        <div class="author-avatar">
                                            <img src="{{ asset('frontend/assets/images/avatar/avt-7.jpg') }}" alt="" class="avatar">
                                            <div class="badge"></div>
                                        </div>
                                        <div class="author-infor">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="#">
                                        <div class='sort-filter active'>
                                            <span><img src="{{ asset('frontend/assets/images/icon/menu.png') }}" alt="" /> All</span>
                                            <i class="fal fa-check"></i>
                                        </div>
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <div class='sort-filter'>
                                            <span><img src="{{ asset('frontend/assets/images/icon/rainbow.png') }}" alt="" /> Art</span>
                                            <i class="fal fa-check"></i>
                                        </div>
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <div class='sort-filter'>
                                            <span><img src="{{ asset('frontend/assets/images/icon/photo.png') }}" alt="" /> Photography</span>
                                            <i class="fal fa-check"></i>
                                        </div>
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <div class='sort-filter'>
                                            <span><img src="{{ asset('frontend/assets/images/icon/itunes.png') }}" alt="" /> Music</span>
                                            <i class="fal fa-check"></i>
                                        </div>
                                    </a>
                                </div>
...
{{--                        </div>--}}
                ...
                <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="sc-card-product">
                        <div class="card-media">
                            <a href="item-details.html"><img src="{{ asset('frontend/assets/images/box-item/card-item-3.jpg') }}" alt="Image"></a>
                            <button class="wishlist-button heart"><span class="number-like"> 100</span></button>
                        </div>
                        <div class="card-title">
                        ...
                        <div class="meta-info">
                            <div class="author">
                                <div class="avatar">
                                    <img src="{{ asset('frontend/assets/images/avatar/avt-1.jpg') }}" alt="Image">
                                </div>
                                <div class="info">
                                    <span>Owned By</span>
                ...
                <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="sc-card-product coming_soon">
                        <div class="card-media">
                            <a href="item-details.html"><img src="{{ asset('frontend/assets/images/box-item/card-item-4.jpg') }}" alt="Image"></a>
                            <button class="wishlist-button heart"><span class="number-like"> 100</span></button>
                        ...
                        <div class="meta-info">
                            <div class="author">
                                <div class="avatar">
                                    <img src="{{ asset('frontend/assets/images/avatar/avt-2.jpg') }}" alt="Image">
                                </div>
                                <div class="info">
                                    <span>Owned By</span>
                                    <h6> <a href="author02.html">SalvadorDali</a> </h6>
                ...
                <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="sc-card-product">
                        <div class="card-media">
                            <a href="item-details.html"><img src="{{ asset('frontend/assets/images/box-item/card-item-2.jpg') }}" alt="Image"></a>
                            <button class="wishlist-button heart"><span class="number-like"> 100</span></button>
                        </div>
                        <div class="card-title">
                        ...
                        <div class="meta-info">
                            <div class="author">
                                <div class="avatar">
                                    <img src="{{ asset('frontend/assets/images/avatar/avt-4.jpg') }}" alt="Image">
                                </div>
                                <div class="info">
                                    <span>Owned By</span>
                                    <h6> <a href="author02.html">SalvadorDali</a> </h6>
                ...
                <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="sc-card-product">
                        <div class="card-media">
                            <a href="item-details.html"><img src="{{ asset('frontend/assets/images/box-item/card-item-7.jpg') }}" alt="Image"></a>
                            <button class="wishlist-button heart"><span class="number-like"> 100</span></button>
                        </div>
                        <div class="card-title">
                        ...
                        <div class="meta-info">
                            <div class="author">
                                <div class="avatar">
                                    <img src="{{ asset('frontend/assets/images/avatar/avt-3.jpg') }}" alt="Image">
                                </div>
                                <div class="info">
                                    <span>Owned By</span>
                                    <h6> <a href="author02.html">SalvadorDali</a> </h6>
                ...
                <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="sc-card-product">
                        <div class="card-media">
                            <a href="item-details.html"><img src="{{ asset('frontend/assets/images/box-item/card-item-9.jpg') }}" alt="Image"></a>
                            <button class="wishlist-button heart"><span class="number-like"> 100</span></button>
                        </div>
                        <div class="card-title">
                ...
                <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="sc-card-product">
                        ...
                        <div class="card-title">
                            <h5 class="style2"><a href="item-details.html">"Living Vase 01 by Lanz...</a></h5>
                            <div class="tags">bsc</div>
                        </div>
                        <div class="meta-info">
                            <div class="author">
                                        ...
                                        <div class="sc-card-collection style-2 home2">
                                            ...
                                            <a href="author02.html">
                                                <div class="media-images-collection">
                                                    <div class="box-left">
                                                        <img src="{{ asset('frontend/assets/images/box-item/collection-item-2.jpg') }}" alt="">
                                                    </div>
                                                    <div class="box-right">
                                                        <div class="top-img">
                                                            <img src="{{ asset('frontend/assets/images/box-item/collection-item-top-1.jpg') }}" alt="">
                                                            <img src="{{ asset('frontend/assets/images/box-item/collection-item-top-2.jpg') }}" alt="">
                                                        </div>
                                                        <div class="bottom-img">
                                                            <img src="{{ asset('frontend/assets/images/box-item/collection-item-bottom-4.jpg') }}" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
                                    ...
                                    <div class="slider-item">
                                        <div class="sc-card-collection style-2 home2">
                                            ...
                                            <a href="author01.html">
                                                <div class="media-images-collection">
                                                    <div class="box-left">
                                                        <img src="{{ asset('frontend/assets/images/box-item/img-collection23.jpg') }}" alt="">
                                                    </div>
                                                    <div class="box-right">
                                                        <div class="top-img">
                                                            <img src="{{ asset('frontend/assets/images/box-item/img-collection24.jpg') }}" alt="">
                                                            <img src="{{ asset('frontend/assets/images/box-item/img-collection10.jpg') }}" alt="">
                                                        </div>
                                                        <div class="bottom-img">
                                                            <img src="{{ asset('frontend/assets/images/box-item/img-collection11.jpg') }}" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
                                    ...
                                    <div class="slider-item">
                                        <div class="sc-card-collection style-2 home2">
                                            ...
                                            <a href="author01.html">
                                                <div class="media-images-collection">
                                                    <div class="box-left">
                                                        <img src="{{ asset('frontend/assets/images/box-item/img-collection12.jpg') }}" alt="">
                                                    </div>
                                                    <div class="box-right">
                                                        <div class="top-img">
                                                            <img src="{{ asset('frontend/assets/images/box-item/img-collection18.jpg') }}" alt="">
                                                            <img src="{{ asset('frontend/assets/images/box-item/img-collection25.jpg') }}" alt="">
                                                        </div>
                                                        <div class="bottom-img">
                                                            <img src="{{ asset('frontend/assets/images/box-item/img-collection17.jpg') }}" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
