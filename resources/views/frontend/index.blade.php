                    ...
                    <div class="slider-item">
                        <div class="themesflat-container ">
                            <div class="wrap-heading flat-slider flex">
                                ...
                                <div class="image">
                                    <img class="img-bg" src="{{ asset('frontend/assets/images/backgroup-secsion/img-bg-sliderhome2.png') }}" alt="Image">
                                    <img src="{{ asset('frontend/assets/images/box-item/imgslider2.png') }}" alt="Image">
                                </div>
                            </div>
