<header id="header_main" class="header_1 js-header">
                        ...
                        <div id="site-logo" class="clearfix">
                            <div id="site-logo-inner">
                                <a href="index.html" rel="home" class="main-logo">
                                    <img id="logo_header" src="{{ asset('frontend/assets/images/logo/logo_dark.png') }}" alt="nft-gaming" width="133" height="56"
                            ...
                            <div class="admin_active" id="header_admin">
                                <div class="header_avatar">
                                                    ...
                                                    <div class="content-inner">
                                                        <div class="wrap-box">
                                                            ...
                                                            <div class="sc-box">
                                                                <div class="content">
                                                                    <div class="avatar">
                                                                        <img src="{{ asset('frontend/assets/images/avatar/avt-6.jpg') }}" alt="">
                                                                    </div>
                                                                    <div class="infor">
                                    ...
                                    <div class="popup-user">
                                        <img class="avatar" src="{{ asset('frontend/assets/images/avatar/avt-5.jpg') }}" alt="avatar"/>
    ...
    <div class="mode_switcher">
        ...
        <a href="#" class="light d-flex align-items-center">
            <img src="{{ asset('frontend/assets/images/icon/sun.png') }}" alt="">
        </a>
        <a href="#" class="dark d-flex align-items-center is_active">
            <img id="moon_dark" src="{{ asset('frontend/assets/images/icon/moon-2.png') }}" alt="">
        </a>
    </div>
</header>
